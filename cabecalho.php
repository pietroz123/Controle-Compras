...
<html lang="pt-br">
    ...
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-147528443-1"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());
            
            gtag('config', 'UA-147528443-1');
        </script>
    </head>
                ...
                <div class="collapse navbar-collapse" id="navbarMenu">
                    ...
                    ?>
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onmouseover="this.classList.add('nav-hover-bg')" onmouseout="this.classList.remove('nav-hover-bg')" href="compras.php">Compras</a>
                            </li>
                            <li class="nav-item">
