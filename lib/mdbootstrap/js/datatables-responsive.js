    ...
    d.extend(i.prototype, {
        ...
        _detailsInit: function() {
            var a = this,
                b = this.s.dt,
                c = this.c.details;
            "inline" === c.type && (c.target = "td:nth-child(2), th:nth-child(2)");
            b.on("draw.dtr", function() {
                a._tabIndexes()
            });
            a._tabIndexes();
        ...
        _tabIndexes: function() {
            ...
            "number" === typeof e ? a.cells(null, e, {
                page: "current"
            }).nodes().to$().attr("tabIndex", c.iTabIndex).data("dtr-keyboard", 1) : ("td:nth-child(2), th:nth-child(2)" === e && (e = ">td:nth-child(2), >th:nth-child(2)"), d(e, a.rows({
                page: "current"
