            ...
            <div class="modal-body">
                <form name="adicionar-username" id="adicionar-username" action="scripts/adicionar-grupo.php" method="post">
                    ...
                    <table class="table" id="campos-dinamicos">
                        <tr>
                            <td><input type="text" name="usernames[]" id="usuario1" placeholder="Digite um nome de usuário" class="form-control input-usuario awesomplete" list="lista-usuarios" data-list="" required></td>
